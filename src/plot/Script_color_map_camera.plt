...
plot "Light_intencity.dat" using 2:1 w d title ''
...
splot "Black_Hall_camera.dat" using 1:2:3 with pm3d title ''
# splot "Black_holl_camera.dat" using 1:2:3 with pm3d title ''
set nomultiplot
pause -1